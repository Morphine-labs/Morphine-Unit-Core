...
// @notice calculate linear cumulative index when borrowing more capital
// @param _amount amount
// @param _desired_amount _desired_amount
// @param _drip_cumulative_index drip cumulative index
// @return cumulativeIndex new cumulativeIndex
@view
