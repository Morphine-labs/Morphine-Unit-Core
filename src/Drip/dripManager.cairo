...
from src.utils.various import ALL_ONES, APPROVE_SELECTOR
...
func openCreditAccount{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (drip_) = IDripFactory.takeCreditAccount(_borrowed_amount, cumulative_index_);
...
@external
func addToken{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        _token: felt) {
...
func dripParameters{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        _drip: felt) -> (borrowedAmount: Uint256, cumulativeIndex: Uint256, currentCumulativeIndex: Uint256) {
...
@view
func allowedTokenLength{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (tokenLength: felt) {
...
func full_collateral_check{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(_drip: felt) {
    ...
    let (is_lt_) = uint256_lt(total_twv_usd_precision_, borrowed_amount_with_interests_usd_precision_);
...
func recursive_calcul_value{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        _oracle_transit: felt,
        _cumulative_twv_usd: Uint256) -> (total_twv_usd: Uint256){
    if(_index == _count){
